...
<div class="user-view">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			?>
			<?php if( Yii::$app->user->isSuperadmin) echo GhostHtml::a(
...
//$qr = QrCode::png(\yii\helpers\Url::toRoute("view?id=".$id, true));
        ...
        ?>
			...
			<?= DetailView::widget([
				...
				'attributes' => [
                                        [
//                'attribute'=>'parent_id',
                'label'=>'QR code'.$model->id,
//                'value' => Html::img(\yii\helpers\Url::to(['/school-management/student/qrcode?id='.$model->id])),
                'value' => Html::img(\yii\helpers\Url::to(['/user-management/user/qrcode?id='.$model->id])),
//                'value' => Html::img($qr ),
                'format'=>'raw',  
            ],
					'id',
