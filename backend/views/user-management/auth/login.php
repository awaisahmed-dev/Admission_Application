...
$cookies = Yii::$app->request->cookies;
$schoolName =  $cookies->getValue('__school_name__');
//die;
?>
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><?= Yii::$app->name. " ". UserManagementModule::t('front', 'Authorization') ?></h3>
				</div>
						...
						'fieldConfig' => [
							'template'=>"{input}\n{error}",
                                    ...
                                    <div class="text-center">
                                        <?php echo Html::img('/img/'.$schoolid.'.png', ['width'=>'150px;', 'height'=>'150px;']);?>
