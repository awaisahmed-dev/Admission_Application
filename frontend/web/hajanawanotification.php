...
$url = 'https://hajanaone.com/api/waAPI.php';
		...
		function SendNOtificationFromHajana($schoolid = 22){
            ...
            //$notificationCount = 0;
        global $conn;
        $sql = "SELECT * FROM notification where school_id='".$schoolid."' AND (medium ='whatsapp' or medium = 'null') AND (STATUS = 1 or STATUS = 101) and created_at > ".strtotime(date('Y-m-d', strtotime( '-2 day') ) )." ORDER BY id DESC LIMIT 3";
